        ...
        {["lg"].map((expand) => (
          <Navbar key={expand} expand={expand} className="header-menu">
            <Container fluid>
              <Navbar.Brand href="/">
                <img
                  src={require("../../assets/images/qool-qatar-logo.png")}
                  alt="headerlogo"
                />
              </Navbar.Brand>
              <Navbar.Toggle
                    ...
                    {JSON.parse(localStorage.getItem("Profile_Data")).error ? (
                      <a href="/signIn">
                        <img
                          ...
                          src={require("../../assets/images/Group2402.png")}
                          alt="profile"
                        />
                      </a>
                    ) : (
                      <div className="mobile-profile-container">
                        <a href="/profile-page?tab=editProfile">
                          <img
                            className="profile-img"
                            src={
                        ...
                        <div className="mobile-profile-container-1">
                          ...
                          <p>
                            {[
                              ...
                              ).payload.phoneNumber.slice(0, 3),
                              " ",
                              JSON.parse(
                                localStorage.getItem("Profile_Data")
                              ).payload.phoneNumber.slice(3, 7),
                              " ",
                              JSON.parse(
                                localStorage.getItem("Profile_Data")
                              ).payload.phoneNumber.slice(7),
                            ].join("")}
                          </p>
                        </div>
                      </div>
                ...
                <Offcanvas.Body>
                  ...
                  <Nav className="justify-content-end">
                    ...
                    {JSON.parse(localStorage.getItem("Profile_Data"))
                      .error ? null : (
                      <a
                        href="/profile-page?tab=notifications"
                        className="meta-icon bbb"
                      >
                        <img
                          className="bbb"
                    ...
                    {JSON.parse(localStorage.getItem("Profile_Data"))
                      .error ? null : (
                      <a
                        href="/profile-page?tab=loyaltyPoints"
                        className="crown-box"
                      >
                        <img
                          src={require("../../assets/images/emojione-v1_crown.png")}
                          alt="crown"
                        />{" "}
                        {
                          JSON.parse(localStorage.getItem("Profile_Data"))
                    ...
                    {JSON.parse(localStorage.getItem("Profile_Data"))
                      .error ? null : (
                      <a
                        href="/profile-page?tab=myBookings"
                        className="meta-icon"
                      >
                        <img
                          src={require("../../assets/images/hCalendar.png")}
                          alt="calendar"
                        />
                      </a>
                    )}
                    ...
                    {JSON.parse(localStorage.getItem("Profile_Data"))
                      .error ? null : (
                      <a
                        href="/profile-page?tab=myWishlist"
                        className="meta-icon"
                      >
                        <img
                          src={require("../../assets/images/hHeart.png")}
                          alt="heart"
                        />
                      </a>
                    )}
                  ...
                  <Nav className="justify-content-end-1">
                    {/* Home */}
                    <a href="/" className="mobile-nav-icon">
                      <img
                        className="mobile-icon-img"
                        src={require("../../assets/images/home_1.png")}
                        alt="home"
                      />
                      <p className="mobile-nav-text">Home</p>
                    </a>
                    {/* Search  */}
                    <a href="#" className="mobile-nav-icon">
                      <img
                        ...
                        alt="home"
                      />
                      <p className="mobile-nav-text">Explore</p>
                    </a>
                    {/* My Bookings */}
                    {JSON.parse(localStorage.getItem("Profile_Data"))
                      .error ? null : (
                      ...
                      >
                        <img
                          ...
                          alt="calendar"
                        />
                        <p className="mobile-nav-text">My Bookings</p>
                      </a>
                    )}
                    {/* WishLists */}
                    {JSON.parse(localStorage.getItem("Profile_Data"))
                      ...
                      >
                        <img
                          ...
                          alt="heart"
                        />
                        <p className="mobile-nav-text">My Wishlist</p>
                      </a>
                    )}
                    {/* Notifications */}
                    {JSON.parse(localStorage.getItem("Profile_Data"))
                      ...
                      >
                        <img
                          className="mobile-icon-img"
                          src={require("../../assets/images/nNotificationn.png")}
                          alt="heart"
                        />
                        <p className="mobile-nav-text">My Notifications</p>
                      </a>
                    )}
                    {/* Log Out */}
                    {JSON.parse(localStorage.getItem("Profile_Data"))
                      .error ? null : (
                      <a onClick={handleClick} className="mobile-nav-icon">
                        <img
                          className="mobile-icon-img"
                          src={require("../../assets/images/logOut.png")}
                          alt="logOut"
                        />
                        <p className="mobile-nav-text">Log Out</p>
                      </a>
                    )}
            ...
            <Col lg={12}>
              <div className="offer-line" onClick={goToLightningDeals}>
                <span className="offer1">
                  ...
                  <Countdown
                    date={
                      "2022-09-31T12:16:37.301Z" || data?.timerDeal?.endDate
                    }
                    renderer={renderer}
                  ></Countdown>
                </span>
                <span className="offer2">
                  Get QAR {data?.timerDeal?.discount}% off
                </span>
                <span>
