    ...
    return (
        <div className="my-reviews">
            ...
            <div>
                ...
                {JSON.parse(localStorage.getItem('Profile_Data')).payload.reviews.map((r) => {
                    // console.log(r.reviewId)
                    return (
                        <div className="col-lg-7 review-box">
                            <div className="d-flex align-content-center mb-3">
                                <img src={r.reviewId.photoUrl} alt="wishlist" className="user-img" />
                                <div>
                                    <p className="my-txt">{r.reviewId.title}</p>
                                    {/* <p className="my-star"><img src={require('../../assets/images/Group3.png')} alt="star" /> {r.star}</p> */}
                                    <p className="my-star"> {r.reviewId.reviewCount} ⭐</p>
                                </div>
                            </div>
                            <p className="">{r.reviewId.description}</p>
                        </div>
                    )
