...
const ListOfActivitiesNearBy = React.lazy(() =>
  import("./pages/list-of-activities-nearby")
);
const AboutEvent = React.lazy(() => import("./pages/about-event"));
const Booking = React.lazy(() => import("./pages/booking"));
const Checkout = React.lazy(() => import("./pages/checkout"));
const BookingAfterPayment = React.lazy(() =>
  import("./pages/booking-after-payment")
);
    ...
    return (
      <Router>
        <Routes>
          ...
          <Route
            path="/list-of-activities-nearby"
            element={<ListOfActivitiesNearBy />}
          />
          <Route path="/about-event" element={<AboutEvent />} />
          <Route path="/booking" element={<Booking />} />
          <Route path="/checkout" element={<Checkout />} />
          <Route
            path="/booking-after-payment"
